...
const Card = ({ children, className }) => (
  <div
    className={`bg-white rounded-[20px] p-4 flex flex-row items-center justify-between gap-4 ${className}`}
  >
    {children}
  </div>
);
    ...
    <div className="p-6">
      ...
      {stats.map((stat) => (
        ...
        >
          ...
          <div className="shrink-0 w-8 h-8 sm:w-10 sm:h-10">{stat.icon}</div>
        </Card>
      ))}
    </div>
