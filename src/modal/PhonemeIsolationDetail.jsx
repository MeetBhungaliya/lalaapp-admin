                ...
                <div className="flex flex-col  gap-5 pt-3 px-8">
                    <div className="flex justify-center items-center gap-4">
                        ...
                        <div className="space-y-1">
                            <p className="sm:text-2xl text-xl font-semibold mt-2">{open?.data?.name}</p>
                            <p className="text-[#7E808C]  text-sm font-medium">Level 01</p>
                            <p className="text-[#7E808C]  text-sm font-medium">Total Sounds - 3</p>
                        </div>
                    ...
                    <div className="flex flex-col gap-0.5">
                        ...
                        <p className="text-base font-normal text-[#7E808C] text-wrap break-words">{open?.data?.question}</p>
                    </div>
                    <ViewSoundField
